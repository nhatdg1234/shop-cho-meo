...
?>
      ...
      <div class="offer">
        <div class="small-contaianer">
            <div class="row">
                <div class="col-2">
                    <img src="./anh/meopng.PNG" class="offer-img">
                </div>
                
                <div class="col-2">
                    <p>độc quyền có sẵn chỉ có trên vku pet shop</p>
                    <h1 class="netchu">Mèo tuxedo</h1>
                    <small class="chunho">Mèo tuxedo là giống mèo Anh đang được ưa chuộng, bộ lông mềm mại và đặc biệt có màu đen trắng rất đặc trưng.</small>
                    <a href="./giaodienhanghiem.html">Đặt hàng ngay &#8594;</a>
                </div>
            </div>
        </div>
      </div>
